...
import com.epam.constants.EpamservicesConstants;



/**
 * This is the extension manager of the Epamservices extension.
 */
public class EpamservicesManager extends GeneratedEpamservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpamservicesManager.class.getName());
	 ...
	 */
	public static EpamservicesManager getInstance()
	{
		return (EpamservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpamservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpamservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpamservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpamservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpamservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
