...
import com.epam.constants.EpamfacadesConstants;



/**
 * This is the extension manager of the Epamfacades extension.
 */
public class EpamfacadesManager extends GeneratedEpamfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpamfacadesManager.class.getName());
	 ...
	 */
	public static EpamfacadesManager getInstance()
	{
		return (EpamfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpamfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpamfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpamfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpamfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpamfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
