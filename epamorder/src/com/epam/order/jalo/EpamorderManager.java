...
import com.epam.order.constants.EpamorderConstants;



/**
 * This is the extension manager of the Epamorder extension.
 */
public class EpamorderManager extends GeneratedEpamorderManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpamorderManager.class.getName());
	 ...
	 */
	public static EpamorderManager getInstance()
	{
		return (EpamorderManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpamorderConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpamorderManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpamorderManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpamorderManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpamorderManager called, current tenant: " + getTenant().getTenantID());
		}
	}
