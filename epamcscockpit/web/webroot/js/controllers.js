...
epamcscockpit.controller("TicketPoolCtrl", function ($scope, $http, $interval, $cookieStore, TicketsResource, TicketCountResource, TicketCountsResource, Auth, userName) {
