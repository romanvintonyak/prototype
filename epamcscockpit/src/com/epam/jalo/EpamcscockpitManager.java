...
import com.epam.constants.EpamcscockpitConstants;



/**
 * This is the extension manager of the Epamcscockpit extension.
 */
public class EpamcscockpitManager extends GeneratedEpamcscockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpamcscockpitManager.class.getName());
	 ...
	 */
	public static EpamcscockpitManager getInstance()
	{
		return (EpamcscockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpamcscockpitConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpamcscockpitManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpamcscockpitManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpamcscockpitManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpamcscockpitManager called, current tenant: " + getTenant().getTenantID());
		}
	}
