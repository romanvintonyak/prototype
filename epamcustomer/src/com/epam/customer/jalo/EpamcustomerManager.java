 ...
 *  
 */
package com.epam.customer.jalo;
...
import com.epam.customer.constants.EpamcustomerConstants;



/**
 * This is the extension manager of the Epamcustomer extension.
 */
public class EpamcustomerManager extends GeneratedEpamcustomerManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpamcustomerManager.class.getName());
	 ...
	 */
	public static EpamcustomerManager getInstance()
	{
		return (EpamcustomerManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpamcustomerConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpamcustomerManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpamcustomerManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpamcustomerManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpamcustomerManager called, current tenant: " + getTenant().getTenantID());
		}
	}
