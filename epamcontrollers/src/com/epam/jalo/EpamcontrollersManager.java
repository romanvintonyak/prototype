...
import com.epam.constants.EpamcontrollersConstants;



/**
 * This is the extension manager of the Epamcontrollers extension.
 */
public class EpamcontrollersManager extends GeneratedEpamcontrollersManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpamcontrollersManager.class.getName());
	 ...
	 */
	public static EpamcontrollersManager getInstance()
	{
		return (EpamcontrollersManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpamcontrollersConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpamcontrollersManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpamcontrollersManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpamcontrollersManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpamcontrollersManager called, current tenant: " + getTenant().getTenantID());
		}
	}
