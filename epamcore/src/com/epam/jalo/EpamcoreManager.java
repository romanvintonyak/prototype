...
import com.epam.constants.EpamcoreConstants;



/**
 * This is the extension manager of the Epamcore extension.
 */
public class EpamcoreManager extends GeneratedEpamcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpamcoreManager.class.getName());
	 ...
	 */
	public static EpamcoreManager getInstance()
	{
		return (EpamcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpamcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpamcoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpamcoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpamcoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpamcoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
