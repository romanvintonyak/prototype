...
import com.epam.ticket.constants.EpamticketConstants;



/**
 * This is the extension manager of the Epamticket extension.
 */
public class EpamticketManager extends GeneratedEpamticketManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpamticketManager.class.getName());
	 ...
	 */
	public static EpamticketManager getInstance()
	{
		return (EpamticketManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpamticketConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpamticketManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpamticketManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpamticketManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpamticketManager called, current tenant: " + getTenant().getTenantID());
		}
	}
