 ...
 *  
 */
package com.epam.pickpack.jalo;
...
import com.epam.pickpack.constants.EpampickpackConstants;



/**
 * This is the extension manager of the Epampickpack extension.
 */
public class EpampickpackManager extends GeneratedEpampickpackManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EpampickpackManager.class.getName());
	 ...
	 */
	public static EpampickpackManager getInstance()
	{
		return (EpampickpackManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EpampickpackConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EpampickpackManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EpampickpackManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EpampickpackManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EpampickpackManager called, current tenant: " + getTenant().getTenantID());
		}
	}
